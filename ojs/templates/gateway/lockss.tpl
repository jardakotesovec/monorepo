...
<a href="https://www.lockss.org/"><img src="{$appBaseUrl}/templates/images/lockss.gif" style="border: 0;" alt="LOCKSS" /></a>
<p>LOCKSS system has permission to collect, preserve, and serve this Archival Unit.</p>

<p><a href="https://pkp.sfu.ca/"><img src="{$baseUrl}/{$pkpLibUrlPath}/templates/images/pkp.gif" style="border: 0;" alt="The Public Knowledge Project" /></a></p>
