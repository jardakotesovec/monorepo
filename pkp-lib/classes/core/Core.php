...
// Filesystem path to pkp-lib, relative to CWD (app dir)
define('PKP_LIB_PATH', defined('PKP_APPLICATION') ? '../pkp-lib' : 'lib/pkp');
// URL path to pkp-lib, relative to document root
define('PKP_LIB_URL_PATH', defined('PKP_APPLICATION') ? 'pkp-lib' : 'lib/pkp');
